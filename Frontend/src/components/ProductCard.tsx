    ...
    >
      ...
      <div className="p-4">
        ...
        <button
          ...
          className={`w-full mt-4 bg-primary text-primary-foreground py-2 rounded-lg font-semibold hover:bg-primary/90 transition-all flex items-center justify-center gap-2 ${
            isAdding ? "scale-95" : ""
          }`}
        >
